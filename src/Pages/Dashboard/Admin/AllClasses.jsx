...
const AllClasses = () => {
  ...
  return (
    <div className="px-4 py-8 max-w-7xl mx-auto">
      <h1 className="font-bold text-center text-4xl mb-6 text-gray-900 dark:text-gray-100 bg-gray-700">
        All Classes
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  ">
        {classes.map((cls) => (
          <div
            key={cls._id}
            className="border rounded-2xl p-4 shadow bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
          >
            <img
              src={cls.image}
              alt={cls.title}
